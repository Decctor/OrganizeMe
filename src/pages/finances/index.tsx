      ...
      <div className="flex w-full grow flex-col bg-[#f8f9fa] p-6">
        <div className="mb-4 flex flex-col items-start">
          <h1 className="text-xl font-bold">
            Olá, <strong className="text-[#2790b0]">{user?.name}</strong>
          </h1>
          ...
          <div className="my-4">
            <div className="flex items-center justify-center gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-xl bg-[#2790b0] p-2 font-medium text-white duration-300 ease-in hover:scale-105"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-xl bg-[#ff0054] p-2 font-medium duration-300 ease-in hover:scale-105"
              >
            ...
            <div className="flex w-full items-center justify-around gap-2">
              <div className="flex w-1/2 flex-col rounded-xl bg-[#fff] p-2 lg:w-1/3">
                <div className="flex w-full items-center justify-between">
                  <div className="flex h-[40px] w-[40px] items-center justify-center rounded-full bg-gray-800 text-white">
                    <RxDownload />
                  </div>
                  <h1 className="font-medium text-gray-500">ENTRADAS</h1>
                ...
                {earnings ? (
                  <p className="w-full text-center text-2xl font-medium text-green-500">
              ...
              <div className="flex w-1/2 flex-col rounded-xl bg-[#fff] p-2 lg:w-1/3">
                <div className="flex w-full items-center justify-between">
                  ...
                  <h1 className="font-medium text-gray-500">SAÍDAS</h1>
                  <div className="flex items-center gap-1 text-[#2790b0]">
                    <BiTrendingUp />
                    <p>2,55%</p>
                  </div>
                ...
                {expenses ? (
                  <p className="w-full text-center text-2xl font-medium text-[#ff0054]">
